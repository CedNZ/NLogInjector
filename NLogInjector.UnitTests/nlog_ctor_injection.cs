...
namespace NLogInjector.UnitTests
{
	...
	public class nlog_ctor_injection
	{
		...
		[Test]
		public void logger_ctor_parameter_should_be_injected_if_used_via_autofac()
		{
	    ...
	    [Test]
	    public void logger_ctor_parameter_should_be_injected_along_with_another_ctor_param_if_used_via_autofac()
	    {
	        var containerBuilder = new ContainerBuilder();
	        containerBuilder.RegisterModule<NLogModule>();
